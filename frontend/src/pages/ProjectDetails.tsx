...
const STATUS_COLORS: Record<string, string> = {
  ...
  PRE_FEASIBILITY: 'bg-violet-100 text-violet-800 border-violet-300',
  FEASIBILITY:     'bg-amber-100 text-amber-800 border-amber-300',
  BANKABLE:        'bg-green-100 text-green-800 border-green-300',
  SUMMIT_FEATURED: 'bg-orange-100 text-orange-800 border-orange-300',
